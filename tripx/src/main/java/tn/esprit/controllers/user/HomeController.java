...
// ============================================
    ...
    // Reserved for future use when Transport page is added
    // @FXML
    // private void handleNavTransport() {
    //     // navigateToTransport();
    // }
    //
    // Reserved for future use when Blog page is added
    // @FXML
    ...
    private void navigateToDestinations(String search) {
        ...
        if (chatPanel != null && chatPanel.getScene() != null) {
            ...
            System.out.println("✅ Scene root changed to destinations");
        } else {
            ...
            e.printStackTrace();
            showAlert("Unexpected error loading destinations");
        }
    }
    ...
    private void navigateToActivities() {
        try {
            ...
            if (loader.getLocation() == null) {
                ...
                System.err.println("📁 Check if file exists at: src/main/resources/fxml/user/user_activities.fxml");
        ...
        if (chatPanel != null && chatPanel.getScene() != null) {
            chatPanel.getScene().setRoot(root);
            System.out.println("✅ Navigated to activities page (setRoot)");
        } else {
            Stage stage = getStage();
            if (stage != null) {
                double width = stage.getWidth();
 ...
 * TO BE IMPLEMENTED WHEN ACCOMMODATION MODULE IS INTEGRATED
 */
/*
@FXML
private void navigateToAccommodations() {
    try {
        String path = "/fxml/user/user_accommodations.fxml";
        ...
        if (loader.getLocation() == null) {
            System.err.println("❌ ERROR: File not found at " + path);
            System.err.println("📁 Check if file exists at: src/main/resources/fxml/user/user_accommodations.fxml");
        ...
        // TODO: Set user in accommodation controller when implemented

        Stage stage = getStage();
        if (stage != null) {
            stage.setScene(new Scene(root));
            stage.centerOnScreen();
            System.out.println("✅ Navigated to accommodations page");
        } else {
 ...
 * TO BE IMPLEMENTED WHEN TRANSPORT MODULE IS INTEGRATED
 */
/*
@FXML
private void navigateToTransport() {
    try {
        String path = "/fxml/user/user_transport.fxml";
        ...
        if (loader.getLocation() == null) {
            System.err.println("❌ ERROR: File not found at " + path);
            System.err.println("📁 Check if file exists at: src/main/resources/fxml/user/user_transport.fxml");
        ...
        // Get controller and set user if needed
        Object ctrl = loader.getController();
        // TODO: Set user in transport controller when implemented
...
*/
     ...
     * TO BE IMPLEMENTED WHEN BLOG MODULE IS INTEGRATED
     */
/*
@FXML
private void navigateToBlog() {
    try {
        ...
        if (loader.getLocation() == null) {
            System.err.println("❌ ERROR: File not found at " + path);
            System.err.println("📁 Check if file exists at: src/main/resources/fxml/user/user_blog.fxml");
...
/*
@FXML
private void handleBrowseAccommodations(ActionEvent event) {
    // Will navigate to accommodations page when implemented
    System.out.println("Browse accommodations clicked");
    showAlert("Accommodations page coming soon!");
}
