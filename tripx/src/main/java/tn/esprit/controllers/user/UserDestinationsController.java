...
public class UserDestinationsController implements Initializable {
    ...
    private void setupActions() {
        ...
        if (backToHomeBtn != null) {
            backToHomeBtn.setOnAction(e -> navigateToHome());
        }
    ...
    private VBox createDestinationCard(Destination destination) {
        ...
        if (destination.getImageUrl() != null && !destination.getImageUrl().isEmpty()) {
            try {
                ImageView imageView = new ImageView(new Image(destination.getImageUrl(), true));
    ...
    private void navigateToAdmin() {
        try {
            ...
            if (backToAdminBtn != null && backToAdminBtn.getScene() != null) {
    ...
    private void navigateToHome() {
        try {
            ...
            if (backToHomeBtn != null && backToHomeBtn.getScene() != null) {
                backToHomeBtn.getScene().setRoot(root);
            }
        } catch (Exception e) {
            e.printStackTrace();
