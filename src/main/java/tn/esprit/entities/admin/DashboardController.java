...
import tn.esprit.controllers.admin.ProfileAdminController;
import tn.esprit.controllers.admin.TransportAdminDashboardController;
import tn.esprit.controllers.admin.UserManagementController;
...
public class DashboardController {
    ...
    private Object[] section(HBox header, VBox menu, String title) {
        ...
        Node parent = header.getParent();
        StringBuilder sb = new StringBuilder(title);
        if (menu != null) {
            for (Node c : menu.getChildren()) {
