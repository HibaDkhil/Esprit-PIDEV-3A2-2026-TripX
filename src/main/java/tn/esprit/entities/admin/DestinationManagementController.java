...
import tn.esprit.controllers.admin.ActivityManagementController;
...
public class DestinationManagementController implements Initializable {
    ...
    private void handleSave() {
        ...
        try {
            ...
            // Handle lat/lng/budget (optional)
            String latTxt = latitudeField != null ? latitudeField.getText().trim() : "";
            String lngTxt = longitudeField != null ? longitudeField.getText().trim() : "";
            String budgetTxt = budgetField != null ? budgetField.getText().trim() : "";
            d.setLatitude(latTxt.isEmpty() ? null : Double.parseDouble(latTxt));
            d.setLongitude(lngTxt.isEmpty() ? null : Double.parseDouble(lngTxt));
            d.setEstimatedBudget(budgetTxt.isEmpty() ? null : Double.parseDouble(budgetTxt));
    ...
    private void populateForm(Destination d) {
        ...
        if (latitudeField != null) latitudeField.setText(d.getLatitude() != null ? String.valueOf(d.getLatitude()) : "");
        if (longitudeField != null) longitudeField.setText(d.getLongitude() != null ? String.valueOf(d.getLongitude()) : "");
        if (budgetField != null) budgetField.setText(d.getEstimatedBudget() != null ? String.valueOf(d.getEstimatedBudget()) : "");
