package tn.esprit.entities.admin;
...
public class BookingManagementController implements Initializable {
    ...
    private void setupTable() {
        colRef.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue() != null && cellData.getValue().getBookingReference() != null ? cellData.getValue().getBookingReference() : ""));
        colDest.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue() != null && cellData.getValue().getDestinationName() != null ? cellData.getValue().getDestinationName() : ""));
        colUser.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue() != null ? String.valueOf(cellData.getValue().getUserId()) : ""));
        colDate.setCellValueFactory(cellData -> new SimpleStringProperty((cellData.getValue() != null && cellData.getValue().getStartAt() != null) ? cellData.getValue().getStartAt().toString() : "N/A"));
        colStatus.setCellValueFactory(cellData -> new SimpleStringProperty((cellData.getValue() != null && cellData.getValue().getStatus() != null) ? cellData.getValue().getStatus().toString() : ""));
