...
import tn.esprit.controllers.admin.AccommodationDetailsController;
import tn.esprit.controllers.admin.AccommodationModalController;
import tn.esprit.controllers.admin.RoomDetailsController;
...
public class AccommodationAdminController {
    ...
    public void initialize() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Accommodation admin initialization failed: " + e.getMessage(), e);
        }
    }
    ...
    private void setupFilters() {
        if (searchField == null || statusFilter == null || typeFilter == null || cityFilter == null || sortBy == null) {
            return;
        }
