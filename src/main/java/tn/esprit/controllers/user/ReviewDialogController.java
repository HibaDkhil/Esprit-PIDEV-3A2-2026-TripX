...
public class ReviewDialogController {
    ...
    public void setTarget(long destinationId, String targetName) {
    ...
    private void loadReviews() {
        ...
        List<Review> reviews = reviewService.getReviews(destinationId);
        ...
        if (reviews.isEmpty()) {
            ...
            double avg = reviewService.getAverageRating(destinationId);
