...
public class UserExchangeController {
    ...
    static {
        ...
        API_KEY = dotenv.get("EXCHANGE_API_KEY");
    }
    ...
    private void handleConvert() {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> showResult(amountTND, converted, rateOneTnd, targetCode));
    ...
    private void showResult(double amountTND, double converted, double rate, String targetCode) {
