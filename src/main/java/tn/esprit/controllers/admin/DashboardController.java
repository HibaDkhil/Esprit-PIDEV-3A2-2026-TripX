...
public class DashboardController {
    ...
    private void setupNavigation() {
        ...
        if (manageDestinationsBtn != null) manageDestinationsBtn.setOnAction(e -> showTransportDestinations());
    ...
    private void resetAllMenuItems() {
        Button[] allButtons = {overviewBtn, statisticsBtn, usersBtn, destinationsBtn, activitiesBtn,
                ...
                manageSchedulesBtn, manageBookingsBtn, manageDestinationsBtn, btnManagePacks, btnManageOffers,
    ...
    private void updateBreadcrumb(Button button) {
        if (button == overviewBtn) {
            ...
            breadcrumb1.setText("Transport");
            breadcrumb2.setText("Manage Destination");
    ...
    @FXML
    private void showTransportDestinations() {
        if (!hasAccess("transport")) { showAccessDenied("Transport Destinations"); return; }
        setActiveButton(manageDestinationsBtn);
        loadTransportView("destinations");
    }
    ...
    private void showSettings() {
        try {
            ...
            if (breadcrumb1 != null) breadcrumb1.setText("Admin");
            if (breadcrumb2 != null) breadcrumb2.setText("Settings");
            resetAllMenuItems();
        } catch (IOException e) {
            e.printStackTrace();
